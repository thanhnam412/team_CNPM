...
export default function ProjectsPage() {
  ...
  const projects = [
    {
      id: "proj-1",
      title: "Build a Customer Churn Prediction Model",
      desc: "An end-to-end machine learning pipeline to predict customer churn using historical data.",
      status: "In Progress",
      ...
      expert: "DataSci_Ninja",
    },
    {
      id: "proj-2",
      title: "Develop RAG Pipeline for Internal Knowledge Base",
      desc: "Implement Retrieval-Augmented Generation using LangChain and Pinecone for our company docs.",
      status: "Review",
      ...
      expert: "LLM_Architect",
    },
    {
      id: "proj-3",
      title: "Computer Vision API for Defect Detection",
      desc: "Deploy a YOLOv8 model via FastAPI to detect manufacturing defects on assembly line images.",
      status: "Open",
    ...
    {
      id: "proj-4",
      title: "Migrate ML Models to AWS SageMaker",
      desc: "Move existing scikit-learn and TensorFlow models to SageMaker endpoints with auto-scaling.",
      status: "Completed",
        ...
        <div className="px-6 py-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mt-1">
              Manage your large-scale AI initiatives
            </p>
          </div>
