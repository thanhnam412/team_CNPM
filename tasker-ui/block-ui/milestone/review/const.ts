  ...
  "data": {
    ...
    "deliverables": [
      {
        ...
        "description": "Complete set of endpoints for chat completion, context management, and user history.",
        "icon": "api",
      ...
      },
      {
        ...
        "description": "Access granted to the main repository branch 'release/v1.0'.",
        "icon": "code",
      ...
      },
      {
        ...
        "description": "Technical architecture, integration guide, and API reference manual.",
        "icon": "picture_as_pdf",
        "action_type": "download",
        "action_label": "Download",
    ...
    "actions": {
      "approve": {
        ...
        "icon": "check_circle",
        "confirmation_message": "Releasing $5,000.00 from escrow to the provider.",
